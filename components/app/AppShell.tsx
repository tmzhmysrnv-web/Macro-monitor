...
// chip with sign-out) + a main content column. Light theme via <AppTheme/>.
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .sb-link:hover { background: var(--c-soft); text-decoration: none; color: var(--c-text); }
        .sb-link.on { background: var(--c-green-bg); color: var(--c-green-deep); font-weight: 500; }
        .sb-digest { margin-top: 22px; background: var(--c-soft); border: 1px solid var(--c-soft-line); border-radius: 12px; padding: 13px; }
        ...
        .sb-digest-s { font-size: 11.5px; color: var(--c-muted); line-height: 1.45; }
        .sb-spacer { flex: 1; }
        .sb-user { display: flex; align-items: center; gap: 10px; padding-top: 16px; margin-top: 16px; border-top: 1px solid var(--c-border); }
        .sb-avatar { width: 34px; height: 34px; border-radius: 50%; overflow: hidden; flex-shrink: 0;
          background: var(--c-green-bg); color: var(--c-green-deep); display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 600; }
        ...
        .sb-user-email { font-size: 11.5px; color: var(--c-muted); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .sb-signout { background: none; border: none; color: var(--c-muted); cursor: pointer; padding: 6px; border-radius: 8px; flex-shrink: 0; }
        .sb-signout:hover { background: var(--c-soft); color: var(--c-text); }
