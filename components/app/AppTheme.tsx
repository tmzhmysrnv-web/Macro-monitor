...
// The calm graphite visual language for the SIGNED-IN app (dashboard, onboarding,
...
export default function AppTheme() {
  return (
    <>
      <style>{`
        .app {
          --c-bg: #1B1C1F; --c-surface: #C7CAC4; --c-soft: #C7CAC4; --c-soft-line: rgba(17,22,18,.2);
          --c-border: rgba(17,22,18,.2); --c-border-strong: rgba(17,22,18,.32);
          --c-text: #111613; --c-text-soft: #3D4741; --c-muted: #68716B;
          --c-page-text: #ECECEA; --c-page-text-soft: #B8BAB6; --c-page-muted: #8F948D;
          --c-green: #6FAE7D; --c-green-deep: #2F8057; --c-green-bg: #D8DED4;
          --c-ok: #2F8057; --c-warn: #B87422; --c-warn-bg: #E7D8C0; --c-bad: #CA4F48; --c-bad-bg: #E6C8C5;
          --c-shell-bg: #18191C; --c-shell-border: rgba(255,255,255,.08);
          --c-shell-text: #ECECEA; --c-shell-text-soft: #B8BAB6; --c-shell-muted: #8F948D;
          --c-shell-green: #6FAE7D; --c-shell-active-bg: #CFD3CB; --c-shell-active-text: #172018;
          --c-sans: var(--font-dm-sans), 'DM Sans', system-ui, sans-serif; --c-mono: var(--font-dm-mono), 'DM Mono', monospace;
          background: var(--c-bg); color: var(--c-page-text); font-family: var(--c-sans);
        ...
        .app .brand { font-family: var(--font-space-mono), 'Space Mono', var(--c-mono); font-size: 14px; font-weight: 400;
          letter-spacing: 0.04em; color: var(--c-shell-green); line-height: 1.3; opacity: .78; }
        .app .brand-cursor { display: inline-block; width: 0.5em; height: 0.95em; margin-left: 3px;
          vertical-align: -0.1em; background: var(--c-shell-green); opacity: .85; animation: brandblink 1.2s steps(1, end) infinite; }
        ...
        .app .btn-primary { background: var(--c-green-deep); color: #fff; }
        ...
        /* ── cards ── */
        .app .calm-card { background: var(--c-surface); border: 1px solid var(--c-border); border-radius: 16px; padding: 22px; color: var(--c-text); }
        ...
        .app .pickcard { text-align: left; background: var(--c-surface); border: 1.5px solid var(--c-border); border-radius: 14px; padding: 16px; cursor: pointer; transition: border-color .15s, background .15s; color: var(--c-text); }
        ...
        .app .auth-box { width: 100%; max-width: 420px; background: var(--c-surface); border: 1px solid var(--c-border); border-radius: 18px; padding: 26px; color: var(--c-text); }
        ...
        .app .p-title { color: var(--c-page-text); }
        .app .p-sub { color: var(--c-page-text-soft); }
        .app .p-saved { color: var(--c-shell-green); }
        .app .main > .sec-title, .app .main > div > .sec-title { color: var(--c-page-text); }
        .app .sp-h1, .app .sp-h2 { color: var(--c-page-text); }
        .app .sp-p, .app .sp-back { color: var(--c-page-text-soft); }
        .app .sp-brand { color: var(--c-shell-green); }
      `}</style>
    </>
  )
}
